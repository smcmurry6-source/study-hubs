...
- `widget/v3.js` + `widget/v3.css` (+ `widget/eggs.js`, the easter eggs) — shared cross-hub layer (search, class stats,
...
- `node --check` on each hub's extracted `<script>` block(s) and on `widget/v3.js` / `widget/eggs.js`.
